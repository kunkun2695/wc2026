          ...
          <div className="mobile-header-content">
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', lineHeight: 1 }}>
                ...
                <span style={{ fontSize: '0.6rem', color: 'rgba(255, 255, 255, 0.4)', fontFamily: 'monospace' }}>v1.1.59</span>
              </div>
            </div>
        ...
        <div className="sidebar-brand" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', lineHeight: 1.1 }}>
              ...
              <span style={{ fontSize: '0.65rem', color: 'rgba(255, 255, 255, 0.4)', fontFamily: 'monospace', marginTop: '2px' }}>v1.1.59</span>
            </div>
          </div>
        </div>
