          ...
          <div className="mobile-header-content">
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', lineHeight: 1 }}>
                ...
                <span style={{ fontSize: '0.6rem', color: 'rgba(255, 255, 255, 0.4)', fontFamily: 'monospace' }}>v1.1.9</span>
              </div>
            </div>
      ...
      <aside className={`sidebar ${activeTab === 'notifications' ? 'sidebar-minimized' : ''}`}>
        <div className="sidebar-brand">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', lineHeight: 1.1 }}>
            ...
            <span style={{ fontSize: '0.65rem', color: 'rgba(255, 255, 255, 0.4)', fontFamily: 'monospace', marginTop: '2px' }}>v1.1.9</span>
          </div>
        </div>
