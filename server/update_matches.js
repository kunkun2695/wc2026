...
async function updateData() {
  try {
    ...
    const matches = [
      ['Thụy Sĩ', '🇨🇭', 'Canada', '🇨🇦', '25.6 - 02:00', 'A'],
      ['Bosnia', '🇧🇦', 'Qatar', '🇶🇦', '25.6 - 02:00', 'B'],
      ['Scotland', '🏴󠁧󠁢󠁳󠁣󠁴󠁿', 'Brazil', '🇧🇷', '25.6 - 05:00', 'C'],
      ['Morocco', '🇲🇦', 'Haiti', '🇭🇹', '25.6 - 05:00', 'D'],
      ['CH Séc', '🇨🇿', 'Mexico', '🇲🇽', '25.6 - 08:00', 'E'],
      ['Nam Phi', '🇿🇦', 'Hàn Quốc', '🇰🇷', '25.6 - 08:00', 'F'],
      ['Curacao', '🇨🇼', 'Bờ Biển Ngà', '🇨🇮', '26.6 - 03:00', 'G'],
      ['Ecuador', '🇪🇨', 'Đức', '🇩🇪', '26.6 - 03:00', 'H'],
      ['Nhật Bản', '🇯🇵', 'Thụy Điển', '🇸🇪', '26.6 - 06:00', 'I'],
      ['Tunisia', '🇹🇳', 'Hà Lan', '🇳🇱', '26.6 - 06:00', 'J'],
      ['Thổ Nhĩ Kỳ', '🇹🇷', 'Mỹ', '🇺🇸', '26.6 - 09:00', 'K'],
      ['Paraguay', '🇵🇾', 'Australia', '🇦🇺', '26.6 - 09:00', 'L']
    ];
